...
5. Ebenfalls dort anpassen: `FFMPEG_FILE` auf 'stille_splitten/bin/ffmpeg' ändern (bzw. den Dateinamen aus Schritt 6)
...
9. `pip3 install -e .` (die ggf. vor Anpassung der Konstanten installierte Version ist nicht nutzbar, um eine portable Version zu erstellen)
